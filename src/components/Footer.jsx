        ...
        <div className="grid md:grid-cols-4 gap-8 text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              {/* <<< NOVO LINK AQUI */}
              <li>
                <Link to="/politica-de-privacidade" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          ...
          <div className="flex gap-4 mt-2 md:mt-0">
            ...
            <p>Feito com 💚 para a saúde brasileira</p>
          </div>
        </div>
      </div>
